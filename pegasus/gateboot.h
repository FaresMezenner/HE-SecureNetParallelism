...
class LWEGateBooter {
 public:
  ...
  void HalfAbs(RLWE2LWECt_t lwe_N, const lwe::Ctx_t lwe_n) const;

  void Half(RLWE2LWECt_t lwe_N, const lwe::Ctx_t lwe_n) const;
  ...
  void Log(RLWE2LWECt_t lwe_N, const lwe::Ctx_t lwe_n) const;
  ...
  void IsNotNegative(RLWE2LWECt_t lwe_N, const lwe::Ctx_t lwe_n) const;
