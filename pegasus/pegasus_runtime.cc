...
double tmp_time = 0.0;
double total_save_model_time = 0.0;
double total_load_model_time = 0.0;
double total_offline_time = 0.0;
double total_online_time = 0.0;
double save_model_time = 0.0;
double load_model_time = 0.0;
double offline_time = 0.0;
double online_time = 0.0;
double vm, vm2, rss, rss2;

bool not_first_epoch;
